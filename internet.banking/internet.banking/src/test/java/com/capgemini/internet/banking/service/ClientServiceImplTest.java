...
import com.capgemini.internet.banking.controllers.ClientController;
...
public class ClientServiceImplTest {
    ...
    public void findAllTest (){
       //Não consegui realizar o teste desse metodo com paginação
    }
    ...
    public void findByidTest(){
        ...
        when(clientService.findByid(model.getClientId())).thenReturn(optional);
